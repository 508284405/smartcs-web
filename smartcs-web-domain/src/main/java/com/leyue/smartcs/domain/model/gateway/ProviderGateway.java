...
public interface ProviderGateway {
     ...
     * @return 是否存在
     */
    boolean existsByProviderType(ProviderType providerType, Long excludeId);
     ...
     * @return 分页结果
     */
    PageResponse<Provider> pageVisualProviders(int pageIndex, int pageSize, String label);
}