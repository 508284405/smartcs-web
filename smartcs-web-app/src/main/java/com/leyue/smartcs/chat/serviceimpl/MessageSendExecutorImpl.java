...
public class MessageSendExecutorImpl implements MessageSendExecutor {
    ...
    @Autowired
    public MessageSendExecutorImpl(WebSocketSessionManager sessionManager,
    ...
    private Message convertToMessage(ChatMessage chatMessage) {
        ...
        } else if ("AGENT".equalsIgnoreCase(chatMessage.getFromUserType())) {
            message.setSenderRole(SenderRole.AGENT);
        } else if ("BOT".equalsIgnoreCase(chatMessage.getFromUserType())) {
