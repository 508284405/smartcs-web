...
public class ChunkGatewayImpl implements ChunkGateway {
    ...
    public List<Chunk> findByContentId(Long contentId) {
        List<ChunkDO> chunkDOList = chunkMapper.selectList(new LambdaQueryWrapper<ChunkDO>()
                .eq(ChunkDO::getContentId, contentId).orderByAsc(ChunkDO::getChunkIndex));
    ...
    @Override
    public PageResponse<Chunk> findByPage(Long contentId, String keyword, Integer chunkIndex, Integer pageIndex,
            Integer pageSize) {
    ...
    public List<Long> deleteByContentId(Long contentId) {
        List<ChunkDO> chunkDOList = chunkMapper
                .selectList(new LambdaQueryWrapper<ChunkDO>().eq(ChunkDO::getContentId, contentId));
